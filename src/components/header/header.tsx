...
export default function Header() {
  ...
  return (
    <header>
      <div className="px-4 py-[14px] pb-5 relative overflow-hidden flex items-center gap-[6px] justify-center">
        ...
        <div className="w-[26px] h-[26px] bg-faintWhite rounded-full flex items-center justify-center cursor-pointer absolute right-[16px] top-[50%] -translate-x-[50%] -translate-y-[50%]">
      ...
      <nav className="h-[68px] lg:h-[77px] border border-r-transparent border-l-transparent border-t-[#211E2F] border-b-[#211E2F] flex items-center bg-faintBg">
        <div className="max-w-[1440px] mx-auto px-4 md:px-[80px] flex items-center justify-between w-full">
          ...
          <button className="hidden lg:block text-sm leading-[21px] py-3 px-5 rounded-[8px] border border-faintWhite bg-background">Contact Us</button>
