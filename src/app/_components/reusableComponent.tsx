...
export default function ReusableComponent({ children, heading, subHeading, btnTxt }: InterfaceProps) {
  return (
    <section className="mb-[65px] md:mb-[90px]">
      ...
      <div className="mb-[40px] md:flex items-center justify-between">
        ...
        <button className="hidden md:block border border-faintWhite h-[49px] px-5 bg-faintBg rounded-[8px]">{btnTxt}</button>
      </div>
      ...
      <section>
        ...
        <div className="mt-[30px] border border-t-faintWhite flex items-center justify-between border-b-0 border-l-0 border-r-0 pt-4 md:relative">
          <button className="md:hidden border border-faintWhite bg-faintBg text-sm leading-[21px] h-[49px] px-5 rounded-[8px]">{btnTxt}</button>
