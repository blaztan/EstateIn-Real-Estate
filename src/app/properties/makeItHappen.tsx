...
export default function MakeItHappen() {
  return (
    <div className="max-w-[1440px] mx-auto px-4 md:px-[80px] mt-[61px] mb-[80px]">
      ...
      <div className="form_grid border border-faintWhite p-5 rounded-[12px] mt-[40px] gap-5 flex flex-col">
        <div>
        ...
        <div>
          ...
          <div className="border border-faintWhite h-[52px] w-full md:w-auto bg-faintBg rounded-[8px] relative flex items-center mt-[16px]">
        ...
        <div>
          ...
          <div className="border border-faintWhite h-[90px] w-full md:w-auto bg-faintBg rounded-[8px] mt-[10px]">
